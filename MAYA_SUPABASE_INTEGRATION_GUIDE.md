...
To use the Supabase integration, you need to create a `.env` file in the `maya-core` directory with the following environment variables:
...
3. Copy the contents of `maya_supabase/schema.sql`
...
2. Run the table creation script:
   ```bash
   python create_supabase_tables_mcp.py
   ```
