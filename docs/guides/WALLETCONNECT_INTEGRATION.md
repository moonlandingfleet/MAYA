...
3. Update the `WC_PROJECT_ID` in `android/gradle.properties` with your actual Project ID:
...
2. Create a new project and obtain your Project ID
3. Update the Infura URL in `backend/main.py`:
...
```
android/app/src/main/java/com/mayaboss/android/
├── network/
