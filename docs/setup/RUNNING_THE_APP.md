...
3. Navigate to the [android](file:///c%3A/Users/bryan/Desktop/MAYA/android) project directory and open it

### 2. Configure WalletConnect

1. Obtain a Project ID from [WalletConnect Cloud](https://cloud.walletconnect.com/)
2. Update the `WC_PROJECT_ID` in `android/gradle.properties` with your actual Project ID
...
2. Update the Infura URL in `backend/main.py`:
...
- `backend/main.py`: Backend with wallet balance endpoints
