...
1. Open the project in Android Studio (navigate to the [android](file:///c%3A/Users/bryan/Desktop/MAYA/android) directory)
...
1. Ensure the backend server is running (in the [backend](file:///c%3A/Users/bryan/Desktop/MAYA/backend) directory)
...
3. **App crashes on launch**
   ...
   - Ensure the backend URL is correctly configured in `android/app/src/main/java/com/mayaboss/android/network/MAYAApiService.kt`

4. **WalletConnect connection issues**
   - Verify your WalletConnect Project ID is correct in `android/gradle.properties`
...
1. Update version codes and names in `android/app/build.gradle`
